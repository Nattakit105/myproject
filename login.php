...
<head>
    ...
    <style>
        ...
        .brand-logo-wrapper {
            ...
            box-shadow: 0 15px 30px -18px rgba(0, 0, 0, 0.65);
        }
        ...
        .card-title { font-weight: 500; font-size: 1.7rem; margin-bottom: 0.2rem; color: var(--text-main); }
        .card-subtitle { color: var(--text-muted); font-size: 0.95rem; margin-bottom: 2.5rem; }

        /* ⌨️ ส่วนของ Input */
        .form-label { font-size: 0.85rem; color: var(--text-muted); margin-bottom: 0.5rem; font-weight: 500; }
        ...
        html[data-theme="light"] .form-control { border-color: #cbd5e1; }
...
<body>
    ...
    <div class="card login-card text-center shadow">
        <div class="brand-logo-wrapper">
            <img src="images/cat.png" alt="โลโก้ปรายฟ้ารีสอร์ท">
        </div>
